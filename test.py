...
pickle_in = open("C:C:\Users\venki\OneDrive\Desktop\Datascience360\VS-Deploy-11-07\data_model.pkl", 'rb') 
...
def main():       
    ...
    <h1 style ="color:black;text-align:center;">Streamlit Price Prediction of EdTech product ML App</h1> 
    </div> 
    """
